      ...
      <div className="space-y-4 px-4 pt-4">
        ...
        >
          ...
          <button
            ...
            className="flex items-center gap-3 rounded-2xl bg-black/10 px-3 py-2 hover:bg-black/15 active:bg-black/20"
            aria-label="Edit team name"
          >
            <div className="h-12 w-12 rounded-2xl bg-black/10 grid place-items-center">
              <Shirt className="h-6 w-6" />
            </div>

            <div className="flex-1">
              <div className="text-base font-extrabold">{teamName}</div>
              <div className="mt-1 text-xs text-black/60">{myFantasyTeam.owner}</div>
            </div>
          </button>
          ...
          <div className="mx-auto my-4 h-0.5 w-14 rounded-full bg-black/15" />
          ...
          <div className="flex items-end justify-center gap-0 px-5 pb-4 pt-2">
            <div className="flex-1 text-center">
              <div className="text-2xl font-bold text-black/80 tabular-nums">
                {avgPointsValue}
              </div>
          ...
          <div className="mx-auto mb-3 h-0.5 w-14 rounded-full bg-black/15" />
          ...
          {statsError && (
            <div className="mt-1 text-center text-xs text-black/60">
              {statsError}
            </div>
          )}
          </div>

          <div className="grid grid-cols-2 gap-0 border-t border-black/15 text-black">
            <Link
              href="/dashboard/fantasy/pick-team"
              className="flex flex-col items-center gap-1 border-r border-black/15 py-4 transition hover:bg-black/10"
            >
            ...
            <Link
              ...
              className="flex flex-col items-center gap-1 py-4 transition hover:bg-black/10"
            >
