...
type StatsTabKey = "goals" | "assists" | "cleanSheets";
...
const playerStats: Record<StatsTabKey, StatRow[]> = {
  goals: [
    { id: "bifa-9", player: "Bifa Striker", teamName: "Bifa", value: 8 },
    { id: "mas-10", player: "Masappe Forward", teamName: "Masappe", value: 6 },
    { id: "acc-7", player: "Accumulators No. 7", teamName: "Accumulators", value: 5 },
    { id: "kom-11", player: "Komunoballo Captain", teamName: "Komunoballo", value: 4 },
  ],
  assists: [
    { id: "bifa-8", player: "Bifa Playmaker", teamName: "Bifa", value: 6 },
    { id: "mas-6", player: "Masappe Midfielder", teamName: "Masappe", value: 5 },
    { id: "acc-10", player: "Accumulators No. 10", teamName: "Accumulators", value: 4 },
    { id: "kom-7", player: "Komunoballo Winger", teamName: "Komunoballo", value: 3 },
  ],
  cleanSheets: [
    { id: "bifa-gk", player: "Bifa Keeper", teamName: "Bifa", value: 3 },
    { id: "mas-gk", player: "Masappe Keeper", teamName: "Masappe", value: 2 },
    { id: "acc-gk", player: "Accumulators Keeper", teamName: "Accumulators", value: 2 },
    { id: "kom-gk", player: "Komunoballo Keeper", teamName: "Komunoballo", value: 1 },
  ],
};

const statsValueLabel: Record<StatsTabKey, string> = {
  goals: "Goals",
  assists: "Assists",
